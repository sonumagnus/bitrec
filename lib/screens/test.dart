...
class GettingStartedCalendarState extends SampleViewState {
  ...
  final List<String> _numberOfDaysList = <String>['default', '1 day', '2 days', '3 days', '4 days', '5 days', '6 days', '7 days'].toList();
  ...
  Widget build(BuildContext context) {
    final Widget calendar = Theme(
        ...
        ///  when we change the parent of the widget
        key: _globalKey,
        data: model.themeData.copyWith(colorScheme: model.themeData.colorScheme.copyWith(secondary: model.backgroundColor)),
        child: _getGettingStartedCalendar(_calendarController, _events, _onViewChanged, _minDate, _maxDate, scheduleViewBuilder));
        ...
        return ListView(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Text('Allow view navigation', softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor)),
                Theme(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text('Show date picker button', softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor)),
                Container(
            ...
            Row(
              ...
              children: <Widget>[
                Expanded(
                    child: Text(model.isWebFullView ? 'Show trailing and leading \ndates' : 'Show trailing and leading dates',
                        softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor))),
                Theme(
                    data: Theme.of(context).copyWith(canvasColor: model.bottomSheetBackgroundColor),
                    child: Align(
                      alignment: Alignment.centerLeft,
            ...
            Row(
              ...
              children: <Widget>[
                Expanded(
                    child: Text(model.isWebFullView ? 'Show current time \nindicator' : 'Show current time indicator',
                        softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor))),
                Theme(
                    data: Theme.of(context).copyWith(canvasColor: model.bottomSheetBackgroundColor),
                    child: Align(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Expanded(child: Text('Show week number', softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor))),
                Theme(
                  data: Theme.of(context).copyWith(canvasColor: model.bottomSheetBackgroundColor),
                  child: Align(
                    alignment: Alignment.centerLeft,
            ...
            Row(
              children: <Widget>[
                Expanded(
                    ...
                    child: Text(model.isWebFullView ? 'View navigation \nmode' : 'View navigation mode',
                        softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor))),
                Expanded(
                    ...
                    child: DropdownButton<String>(
                        ...
                        items: _viewNavigationModeList.map((String value) {
                          return DropdownMenuItem<String>(
                              value: value, child: Text(value, textAlign: TextAlign.center, style: TextStyle(color: model.textColor)));
                        }).toList(),
            ...
            Row(
              children: <Widget>[
                Expanded(
                    flex: model.isWebFullView ? 5 : 6,
                    child: Text('Number of days', softWrap: false, style: TextStyle(fontSize: 16.0, color: model.textColor))),
                Expanded(
  ...
  SfCalendar _getGettingStartedCalendar(
    ...
    return SfCalendar(
      ...
      blackoutDatesTextStyle: TextStyle(decoration: model.isWebFullView ? null : TextDecoration.lineThrough, color: Colors.red),
      minDate: minDate,
      maxDate: maxDate,
      monthViewSettings: MonthViewSettings(
          appointmentDisplayMode: MonthAppointmentDisplayMode.appointment, showTrailingAndLeadingDates: _showLeadingAndTrailingDates),
      timeSlotViewSettings: TimeSlotViewSettings(numberOfDaysInView: _numberOfDays, minimumAppointmentDuration: const Duration(minutes: 60)),
