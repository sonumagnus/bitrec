...
class WebLayoutPage extends StatefulWidget {
  ...
  const WebLayoutPage({this.sampleModel, this.category, Key? key, this.subItem, this.routeName}) : super(key: key);
...
class _WebLayoutPageState extends State<WebLayoutPage> {
  ...
  void initState() {
    ...
    if (sample.parentIndex != null) {
      orginText = '${sample.control!.title! + ' > ' + sample.control!.subItems![sample.parentIndex!].title} > ' +
          sample.control!.subItems![sample.parentIndex!].subItems[sample.childIndex].title;
    } else {
      if (sample.childIndex != null && (widget.subItem!.control!.subItems![sample.childIndex!]! as SubItem).subItems!.length > 1) {
        orginText = '${'${sample.control!.title!} > ' + widget.subItem!.control!.subItems![sample.childIndex!].title} > ${sample.title!}';
      } else {
    ...
    subItems =
        sample.parentIndex != null ? sample.control!.subItems![sample.parentIndex!].subItems[sample.childIndex].subItems as List<SubItem> : null;
  ...
  Widget build(BuildContext context) {
    ...
    if (SampleModel.sampleRoutes.isNotEmpty &&
        SampleModel.sampleRoutes.any((SampleRoute element) => element.routeName != model.currentSampleRoute.routeName)) {
    ...
    return Scaffold(
        ...
        drawer: (MediaQuery.of(context).size.width > 768)
            ? Container()
            : SizedBox(
                width: MediaQuery.of(context).size.width * (MediaQuery.of(context).size.width < 500 ? 0.65 : 0.4),
                child: Drawer(
                    key: const PageStorageKey<String>('pagescrollmaintain'),
                    child: Container(
                        color: model.webBackgroundColor,
                        padding: const EdgeInsets.only(top: 5),
                        child: _SampleInputContainer(sampleModel: model, category: category, key: sampleInputKey, webLayoutPageState: this)))),
            ...
            child: Container(
              ...
              child: AppBar(
                leading: (MediaQuery.of(context).size.width > 768)
                    ...
                    : IconButton(
                        ...
                        onPressed: () {
                          ...
                          if (popupState.scaffoldKey.currentState != null && popupState.scaffoldKey.currentState!.isEndDrawerOpen) {
                            Navigator.pop(context);
                          }
                ...
                title: const Text('Flutter UI Widgets ',
                    style: TextStyle(color: Colors.white, fontSize: 18, letterSpacing: 0.53, fontFamily: 'Roboto-Medium')),
                actions: <Widget>[
                                ...
                                child: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('DOWNLOAD NOW',
                                        style: TextStyle(
                                            color: isHoveringDownloadButton ? model.paletteColor : Colors.white,
                                            fontSize: 12,
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(children: <Widget>[
                                        Image.asset('images/pub_logo.png', fit: BoxFit.contain, height: 33, width: 33),
                                        Text('Get Packages',
                                            style: TextStyle(
                                                color: isHoveringPubDevButton ? model.paletteColor : Colors.white,
                                                fontSize: 12,
                                                fontFamily: 'Roboto-Medium'))
                                      ]),
                                    ),
              ...
              if (MediaQuery.of(context).size.width <= 768)
                ...
                SizedBox(
                    ...
                    child: inputContainer =
                        _SampleInputContainer(sampleModel: model, category: category, key: sampleInputKey, webLayoutPageState: this)),
...
class _SampleInputContainer extends StatefulWidget {
  const _SampleInputContainer({this.sampleModel, this.category, this.webLayoutPageState, this.key}) : super(key: key);
...
class _SampleInputContainerState extends State<_SampleInputContainer> {
  ...
  Widget _expandedChildren(SampleModel model, SubItem item, WidgetCategory category, int index) {
    GlobalKey<State>? currentGlobalKey;
    _ExpansionKey? currentExpansionKey;
    if (initialRender) {
      currentGlobalKey = GlobalKey<State>();
      currentExpansionKey = _ExpansionKey(expansionIndex: index, isExpanded: index == 0, globalKey: currentGlobalKey);
    ...
    if (item.subItems != null && item.subItems!.isNotEmpty) {
      if (item.subItems!.length != 1) {
        ...
        final bool isNeedSelect = currentSample.breadCrumbText == item.subItems![0].breadCrumbText;
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                final _SampleInputContainerState sampleInputContainerState =
                    widget.webLayoutPageState!.sampleInputKey.currentState! as _SampleInputContainerState;
                ...
                outputContainerState.orginText = '${widget.webLayoutPageState!.sample.control!.title!} > ' + item.subItems![0].title!;

                widget.webLayoutPageState!.selectSample = item.title;
                widget.webLayoutPageState!.sample = item.subItems != null ? item.subItems![0] as SubItem : item;
                if (model.currentSampleKey == null ||
                    (item.key != null ? model.currentSampleKey != item.key : model.currentSampleKey != item.subItems![0].key)) {
                  sampleInputContainerState.refresh();
                  outputContainerState.refresh();
                }
              },
              child: Container(
                  color: isNeedSelect ? Colors.grey.withOpacity(0.2) : Colors.transparent,
                  child: Row(children: <Widget>[
                    Container(
                        color: isNeedSelect ? model.backgroundColor : Colors.transparent,
                        width: 5,
                        height: 40,
                    ...
                    Expanded(
                        child: Container(
                            ...
                            child: Text(item.subItems![0].title!,
                                style: TextStyle(
                                    fontSize: 13, fontFamily: 'Roboto-Medium', color: isNeedSelect ? model.backgroundColor : model.textColor)))),
                    if (item.subItems![0].status != null && item.subItems![0].status != '')
                      Container(
                          decoration: BoxDecoration(
                              color: item.subItems![0].status == 'New' ? const Color.fromRGBO(55, 153, 30, 1) : const Color.fromRGBO(246, 117, 0, 1),
                          ...
                          child: Text(item.subItems![0].status, style: const TextStyle(fontSize: 10.5, color: Colors.white)))
                    else
                      Container(),
                    if (item.subItems![0].status != null && item.subItems![0].status != '')
      ...
      childWidget = Material(
          ...
          child: InkWell(
              ...
              onTap: () {
                ...
                outputContainerState.orginText = '${widget.webLayoutPageState!.sample.control!.title!} > ${item.title!}';
              ...
              child: Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(item.title!, style: TextStyle(color: model.textColor, fontSize: 13, fontFamily: 'Roboto-Regular')))));
    }
    return childWidget;
  }

  List<Widget> _getSampleList(SampleModel model, WidgetCategory category) {
    final List<SubItem> list = widget.webLayoutPageState!.sample.control!.subItems! as List<SubItem>;
    final List<Widget> children = <Widget>[];
    for (int i = 0; i < list.length; i++) {
      final bool isNeedSelect = widget.webLayoutPageState!.selectSample == null
          ? widget.webLayoutPageState!.sample.breadCrumbText == list[i].breadCrumbText
          ...
          child: list[i].type != 'parent' && list[i].type != 'child'
              ? InkWell(
                  ...
                  onTap: () {
                    ...
                    outputContainerState.needTabs = false;
                    outputContainerState.orginText = '${widget.webLayoutPageState!.sample.control!.title!} > ${list[i].title!}';
                    widget.webLayoutPageState!.selectSample = list[i].title;
                    if (model.currentSampleKey == null ||
                        (list[i].key != null ? model.currentSampleKey != list[i].key : model.currentSampleKey != list[i].subItems![0].key)) {
                      sampleInputContainerState.refresh();
                      outputContainerState.refresh();
                    }
                  },
                      ...
                      child: Row(children: <Widget>[
                        ...
                        Expanded(
                            child: Container(
                                ...
                                child: Text(
                                  list[i].title!,
                                  style: TextStyle(color: isNeedSelect ? model.backgroundColor : model.textColor),
                                ))),
                        if (list[i].status != null && _getSampleStatus(model, list[i], context))
                          Container(
                              decoration: BoxDecoration(
                              ...
                              padding: (model.isWeb && model.isMobileResolution)
                                  ? const EdgeInsets.fromLTRB(3, 1, 3, 5.5)
                                  : const EdgeInsets.fromLTRB(5, 2.7, 5, 2.7),
                              child: Text(list[i].status!, style: const TextStyle(color: Colors.white, fontSize: 10.5)))
                        else
                          Container(),
                        if (list[i].status != null && _getSampleStatus(model, list[i], context))
                          const Padding(padding: EdgeInsets.only(right: 5))
  ...
  bool _getSampleStatus(SampleModel model, SubItem sample, BuildContext context) {
    ...
    try {
      isPlatformSpecified = currentSample.hideSampleStatus != null && currentSample.hideSampleStatus! == true;
      // ignore: empty_catches
    } catch (e) {}
    hideStatus = sample.status != null && (isPlatformSpecified == null || isPlatformSpecified == true);
    return hideStatus;
  }
      ...
      if (SampleModel.sampleRoutes.isNotEmpty) {
        for (int i = SampleModel.sampleRoutes.length - 1; i >= 0; i--) {
          if (i >= 0 && i <= SampleModel.sampleRoutes.length - 1) {
            ...
            if (sampleModel.currentSampleRoute.routeName! != currentSampleRoute.routeName!) {
              if (currentSampleRoute.routeName != null) {
                SampleModel.sampleRoutes.removeAt(i);
                isReplaced = true;
                await Navigator.of(context).pushReplacementNamed<dynamic, dynamic>(currentSampleRoute.routeName!);
              }
            }
          }
        }
    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
              ...
              child: InkWell(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Icon(Icons.arrow_back, size: 20, color: sampleModel.backgroundColor),
                    Flexible(
                        child: Container(
                            padding: const EdgeInsets.only(left: 12),
                            child: Text(
                              ...
                              maxLines: 1,
                              style: TextStyle(color: sampleModel.backgroundColor, fontSize: 16, fontFamily: 'Roboto-Medium'),
                            ))),
                    Container(width: 2),
            ...
            Expanded(child: ListView(children: _getSampleList(sampleModel, category)))
          ],
        ));
  }
}
...
class SampleOutputContainerState extends State<_SampleOutputContainer> {
  ...
  void initState() {
    ...
    _prevCategory =
        widget.webLayoutPageState != null && widget.webLayoutPageState!.selectSample != null ? widget.webLayoutPageState!.selectSample : 'Line';
    super.initState();
  }
  ...
  bool _checkPropertyPanelIsEnabled(SampleModel model, SubItem sample, _PropertiesPanel propertiesPanel, BuildContext context) {
    final Function? sampleView = model.sampleWidget[sample.key];
    final dynamic currentSample = sampleView!(GlobalKey<State>());
    _needsPropertyPanel = sample.needsPropertyPanel ?? false;
    bool? isPlatformSpecified;
    try {
      isPlatformSpecified = currentSample.needsPropertyPanel != null && currentSample.needsPropertyPanel! == true;
      // ignore: empty_catches
    } catch (e) {}
    _needsPropertyPanel = (sample.needsPropertyPanel ?? false) && (isPlatformSpecified == null || isPlatformSpecified == true);
  ...
  Widget build(BuildContext context) {
    ...
    final SubItem sampleSubItem = (_initialRender ? widget.initialSample : sample)!;
    _propertiesPanel = _PropertiesPanel(sampleModel: model, key: _propertiesPanelKey);
    _tabTextWidth = 0;
    final List<Widget>? tabs = (needTabs ?? false) && subItems.length > 1 ? _getTabs(subItems) : null;
    ...
    return Theme(
      data: ThemeData(
          brightness: model.themeData.colorScheme.brightness, primaryColor: model.backgroundColor, colorScheme: model.themeData.colorScheme),
      child: Expanded(
          child: Container(
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Text('${sampleSubItem.title!} ',
                          style: TextStyle(color: model.textColor, letterSpacing: 0.39, fontSize: 18, fontFamily: 'Roboto-Medium'))),
                  Container(
                      padding: const EdgeInsets.only(left: 10, top: 10),
                      alignment: Alignment.centerLeft,
                      child: Text((needTabs ?? false) && subItems.length != 1 ? '$orginText > ${sampleSubItem.title!}' : orginText,
                          style: TextStyle(color: model.textColor.withOpacity(0.65), letterSpacing: 0.3, fontFamily: 'Roboto-Regular'))),
                  ...
                  Expanded(
                      child: Scaffold(
                          ...
                          endDrawerEnableOpenDragGesture: false,
                          endDrawer: _checkPropertyPanelIsEnabled(model, sampleSubItem, _propertiesPanel, context) ? _propertiesPanel : null,
                          body: (needTabs ?? false)
                              ? DefaultTabController(
                                  initialIndex: (tabIndex ?? widget.webLayoutPageState!.sample.sampleIndex)!,
                                  key: UniqueKey(),
                                        ...
                                        children: <Widget>[
                                          Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                border: Border(bottom: BorderSide(color: model.dividerColor, width: 0.8)),
                                              ),
                                              padding: width < 500 ? const EdgeInsets.fromLTRB(2, 5, 2, 0) : const EdgeInsets.fromLTRB(5, 0, 10, 0),
                                                                                      ...
                                                                                      onTap: (int value) {
                                                                                        ...
                                                                                        if (model.currentSampleKey == null ||
                                                                                            model.currentSampleKey !=
                                                                                                outputContainerState.sample.key) {
                                                                                          outputContainerState.refresh();
                                                                                        }
                                                                                      },
                                                          ...
                                                          Align(
                                                              ...
                                                              child: Container(
                                                                decoration: BoxDecoration(
                                                                  ...
                                                                  colors: <Color>[
                                                                    model.webInputColor.withOpacity(0.21),
                                                                    model.webInputColor.withOpacity(1.0)
                                                                  ],
                                                          ...
                                                          Align(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Material(
                                                                    ...
                                                                    child: InkWell(
                                                                        hoverColor:
                                                                            _isRightScrolled ? Colors.grey.withOpacity(0.3) : Colors.transparent,
                                                      ...
                                                      Flexible(
                                                        child: Material(
                                                          ...
                                                          child: InkWell(
                                                              hoverColor: Colors.grey.withOpacity(0.3),
                                                              onTap: () {
                                                                performMaximize(model, sampleSubItem);
                                                              },
                                                              child: Tooltip(
                                                                  message: 'Maximize',
                                                                  child: Ink(
                                                                      ...
                                                                      child: Transform.scale(
                                                                        scale: 0.85,
                                                                        child: Icon(Icons.open_in_full, color: model.webIconColor),
                                                                      )))),
                                                        ),
                                                      ),
                                                      Padding(padding: EdgeInsets.only(left: width < 500 ? 3 : 6)),
                                          ...
                                          Expanded(
                                            ...
                                            child: TabBarView(
                                                physics: const NeverScrollableScrollPhysics(), children: _getTabViewChildren(model, subItems)),
                                          )),
                                        ],
                                      )))
                              : Container(
                                  decoration: BoxDecoration(
                                    color: model.webOutputContainerColor,
                                    border: Border.all(
                                        color: (model.themeData.colorScheme.brightness == Brightness.light ? Colors.grey[300] : Colors.transparent)!),
                                    borderRadius: BorderRadius.circular(3),
                                  ),
                                  child: Column(
                                    children: <Widget>[
                                                  ...
                                                  ? StatefulBuilder(builder: (BuildContext context, StateSetter stateSetter) {
                                                      return Material(
                                                          ...
                                                          child: ToggleButtons(
                                                              ...
                                                              children: <Widget>[
                                                                Tooltip(
                                                                  message: MediaQuery.of(context).size.width <= 720 || !model.isPropertyPanelOpened
                                                                      ? 'Open Property Panel'
                                                                      : 'Close Property Panel',
                                                                  child: Icon(Icons.menu, color: model.webIconColor),
                                                                )
  ...
  bool _isLeftSideScrolled() {
    ...
    if ((_scrollbarWidth + 10 < _tabTextWidth) &&
            // ignore: invalid_use_of_protected_member
            (_controller!.positions.isNotEmpty && _controller!.position.pixels > 25) ||
        (_prevCategory == _currentCategory && _prevPosition != null && _prevPosition! > 25)) {
  ...
  bool _isRightSideScrolled() {
    ...
    if (_scrollbarWidth + 10 < _tabTextWidth &&
        // ignore: invalid_use_of_protected_member
        ((_controller!.positions.isNotEmpty && (_controller!.position.pixels - _controller!.position.maxScrollExtent).abs() > 25) ||
            (_prevCategory == _currentCategory && _prevPosition != null && (_prevPosition! - _prevScrollExtent!).abs() > 25) ||
            // ignore: invalid_use_of_protected_member
            (_controller!.positions.isEmpty && (_prevPosition == null || _prevCategory != _currentCategory)))) {
  ...
  void performMaximize(SampleModel model, SubItem sample) {
    ...
    final _PopupState state = widget.webLayoutPageState!.popUpKey.currentState! as _PopupState;
    state._sampleDetails = sample;
    state._currentWidgetKey = model.currentRenderSample.key as GlobalKey;
    final _OutputContainerState outputContainerState = _outputKey.currentState! as _OutputContainerState;
  ...
  Size _measureTextSize(String textValue, TextStyle textStyle) {
    final TextPainter textPainter =
        TextPainter(textAlign: TextAlign.center, textDirection: TextDirection.ltr, text: TextSpan(text: textValue, style: textStyle));
    textPainter.layout();
  ...
  List<Widget> _getTabs(List<SubItem> list) {
    ...
    for (int i = 0; i < list.length; i++) {
      if (list.isNotEmpty) {
        const String status = "getStatusTag(list[i])";
        _tabTextWidth +=
            _measureTextSize(list[i].title.toString() + (status != '' ? '  ' : ''), const TextStyle(letterSpacing: 0.5, fontFamily: 'Roboto-Medium'))
                    .width +
                _measureTextSize(
                        status == 'New'
                            ? 'N'
        ...
        tabs.add(Tab(
            child: Row(
          children: <Widget>[
            Text(list[i].title.toString() + (status != '' ? '  ' : ''), style: const TextStyle(letterSpacing: 0.5, fontFamily: 'Roboto-Medium')),
            if (status == '')
              Container()
            else
              Container(
                ...
                decoration: const BoxDecoration(
                  color: status == 'New'
                      ? Color.fromRGBO(55, 153, 30, 1)
                      : status == 'Updated'
                          ? Color.fromRGBO(246, 117, 0, 1)
                          : Colors.transparent,
                  shape: BoxShape.circle,
                ),
                alignment: Alignment.center,
...
class _OutputContainer extends StatefulWidget {
  const _OutputContainer({this.sampleModel, this.key, this.subItem, this.sampleView, this.sampleOutputContainerState}) : super(key: key);
...
class _OutputContainerState extends State<_OutputContainer> {
  ...
  bool _checkPropertyPanelIsEnabled(SampleModel model, BuildContext context) {
    ...
    _needsPropertyPanel = (widget.subItem!.needsPropertyPanel ?? false) && (isPlatformSpecified == null || isPlatformSpecified == true);
    return _needsPropertyPanel;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.sampleModel!.oldWindowSize!.width != widget.sampleModel!.currentWindowSize.width ||
              ...
              return Row(children: <Widget>[
                Expanded(
                  ...
                  children: <Widget>[
                    ...
                    if (widget.subItem!.sourceLink != null && widget.subItem!.sourceLink != '')
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(
                                'Source: ',
                                style: TextStyle(color: widget.sampleModel!.textColor.withOpacity(0.65), fontSize: 12),
                              ),
                              InkWell(
                                onTap: () {},
                                child: Text(widget.subItem!.sourceText!, style: const TextStyle(fontSize: 12, color: Colors.blue)),
                              ),
                            ],
                          ),
                        ),
                ...
                if (_needsPropertyPanel &&
                    ...
                    (widget.sampleModel!.isPropertyPanelOpened ||
                        (!widget.sampleModel!.isPropertyPanelOpened && widget.sampleModel!.isPropertyPanelTapped)))
                  _PropertiesPanel(
                    sampleModel: widget.sampleModel,
      ...
      widget.sampleModel!.currentRenderSample = renderWidget ?? widget.sampleView!(GlobalKey<State>());
      renderWidget = null;
      widget.sampleModel!.propertyPanelKey = widget.sampleModel!.currentRenderSample.key as GlobalKey;
      widget.sampleModel!.currentSampleKey = widget.subItem!.key;
      return ClipRect(
          child: MaterialApp(
              ...
              theme: ThemeData(
                  checkboxTheme: CheckboxThemeData(fillColor: MaterialStateProperty.resolveWith(getColor)),
                  brightness: widget.sampleModel!.themeData.colorScheme.brightness,
                            ...
                            return Row(children: <Widget>[
                              ...
                              if (_needsPropertyPanel &&
                                  ...
                                  (widget.sampleModel!.isPropertyPanelOpened ||
                                      (!widget.sampleModel!.isPropertyPanelOpened && widget.sampleModel!.isPropertyPanelTapped)))
                                _PropertiesPanel(
                                    sampleModel: widget.sampleModel, subItem: widget.subItem, key: propertyPanelWidgetKey, openState: true)
                              else
                                Container()
                            ]);
                          }))
...
class _PropertiesPanel extends StatefulWidget {
  const _PropertiesPanel({this.sampleModel, this.openState, this.subItem, this.key}) : super(key: key);
  final SampleModel? sampleModel;
...
class _PropertiesPanelState extends State<_PropertiesPanel> with SingleTickerProviderStateMixin {
  ...
  Widget? _getSettingsView(GlobalKey sampleKey) {
    if (sampleKey.currentState != null) {
      final SampleViewState sampleState = sampleKey.currentState! as SampleViewState;
      final bool isLocalizationSample = sampleKey.currentState! is LocalizationSampleViewState;
      final bool isDirectionalitySample = sampleKey.currentState! is DirectionalitySampleViewState;

      if (isLocalizationSample || isDirectionalitySample) {
        return ListView(shrinkWrap: true, children: <Widget>[
          (sampleKey.currentState! as LocalizationSampleViewState).localizationSelectorWidget(context),
          if (isDirectionalitySample)
            (sampleKey.currentState! as DirectionalitySampleViewState).textDirectionSelectorWidget(context)
          else
            Container(),
  ...
  Widget build(BuildContext context) {
    final SampleModel model = widget.sampleModel!;
    final Widget? settingPanelContent = _getSettingsView(model.propertyPanelKey);
          ...
          builder: (BuildContext context, Widget? child) {
            return Theme(
              data: ThemeData(
                  ...
                  colorScheme: widget.sampleModel!.themeData.colorScheme),
              child: SizedBox(
                  width: (widget.openState ?? false) ? animation.value * 275 : (animation.value * 275),
                  child: Drawer(
                      elevation: 3,
                      child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: (widget.openState ?? false)
                                ? Border(left: BorderSide(color: widget.sampleModel!.textColor.withOpacity(0.3), width: 0.5))
                                : Border.all(color: const Color.fromRGBO(0, 0, 0, 0.12), width: 2),
                          ),
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                                    ...
                                    if (widget.openState ?? false)
                                      ...
                                      Material(
                                          ...
                                          child: IconButton(
                                            hoverColor: Colors.grey.withOpacity(0.3),
                                            icon: Icon(Icons.close, color: widget.sampleModel!.webIconColor),
                                            onPressed: () {
                                              Navigator.pop(context);
                                            },
                                          ))
...
class _TileContainer extends StatefulWidget {
  const _TileContainer({this.sampleModel, this.category, this.webLayoutPageState, this.item, this.expansionKey, this.key}) : super(key: key);
...
class _PopupState extends State<_Popup> {
  ...
  bool _checkPropertyPanelIsEnabled(BuildContext context) {
    ...
    _needsPropertyPanel = (_sampleDetails!.needsPropertyPanel ?? false) && (isPlatformSpecified == null || isPlatformSpecified == true);
    return _needsPropertyPanel;
  }
                ...
                child: _sampleDetails != null
                    ? Theme(
                        ...
                        child: Scaffold(
                            ...
                            appBar: PreferredSize(
                                ...
                                child: AppBar(
                                    title: Text(_sampleDetails!.title!,
                                        style: TextStyle(fontFamily: 'Roboto-Medium', fontSize: 16, color: model!.textColor)),
                                        ...
                                        SizedBox(
                                            ...
                                            child: Material(
                                                ...
                                                child: Tooltip(
                                                    ...
                                                    child: IconButton(
                                                      hoverColor: Colors.grey.withOpacity(0.3),
                                                      icon: Icon(Icons.menu, color: model!.webIconColor),
                                                      onPressed: () {
                                                        model!.propertyPanelKey = _currentWidgetKey!;
                                                        scaffoldKey.currentState!.openEndDrawer();
                                                      },
                                                    ))))
                                      else
                                            ...
                                            child: IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                final _OutputContainerState outputContainerState =
                                                    model!.outputContainerState as _OutputContainerState;
                                                outputContainerState.setState(() {
                                                  outputContainerState.renderWidget = _currentWidgetKey?.currentWidget;
                                                });
                                                _sampleDetails = null;
                                                refresh(false);
                                              },
                            ...
                            backgroundColor:
                                model!.themeData.colorScheme.brightness == Brightness.dark ? const Color.fromRGBO(33, 33, 33, 1) : Colors.white,
