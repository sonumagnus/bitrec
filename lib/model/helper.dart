...
void onTapControlInMobile(BuildContext context, SampleModel model, WidgetCategory category, int position) {
  category.selectedIndex = position;
  Navigator.push<dynamic>(context, MaterialPageRoute<dynamic>(builder: (BuildContext context) => LayoutPage(sampleModel: model, category: category)));
}
...
void resetLocaleValue(SampleModel model, SubItem currentSample) {
  ...
  if ((currentSample.title!.toLowerCase().contains('rtl') || currentSample.title!.toLowerCase().contains('directionality'))) {
...
void onTapControlInWeb(BuildContext context, SampleModel model, WidgetCategory category, int position) {
  category.selectedIndex = position;
  final SubItem subItem = category.controlList![category.selectedIndex!].subItems[0].type == 'parent'
      ? category.controlList![category.selectedIndex!].subItems[0].subItems[0].subItems[0] as SubItem
      : category.controlList![category.selectedIndex!].subItems[0].type == 'child'
          ? category.controlList![category.selectedIndex!].subItems[0].subItems[0] as SubItem
...
void onTapExpandSample(BuildContext context, SubItem subItem, SampleModel model) {
...
List<TextSpan> getTextSpan(String description, SampleModel model) {
  ...
  for (int i = 0; i < value.length; i++) {
    if (value[i].contains('<highlight>') && value[i].contains('<endHighlight>')) {
    ...
    } else if (value[i] == '<endHighlight>' || value[i].contains('<endHighlight>')) {
      String word = '';
    ...
    } else if (!value[i].contains('<highlight>') && !value[i].contains('<endHighlight>')) {
      if (overallText != null) {
...
class _FullViewSampleLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool needsFloatingBotton = (sample!.sourceLink != null && sample!.sourceLink != '') || (sample!.needsPropertyPanel ?? false);
    final bool needPadding = sample!.codeLink != null && sample!.codeLink!.contains('/chart/');
            ...
            child: sample == null
                ...
                : Theme(
                    ...
                    child: Scaffold(
                                    ...
                                    if (sample!.codeLink != null && sample!.codeLink != '')
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          ...
                                          width: 37,
                                          child: IconButton(
                                            icon: Image.asset('images/git_hub_mobile.png', color: Colors.white),
                                            onPressed: () {},
                                          ),
                                        ),
                                      )
                      ...
                      body: Container(
                          decoration: BoxDecoration(borderRadius: const BorderRadius.vertical(top: Radius.circular(12)), color: model.cardThemeColor),
                          padding: needPadding ? EdgeInsets.fromLTRB(5, 0, 5, needsFloatingBotton ? 57 : 0) : EdgeInsets.zero,
                          child: Container(child: sampleWidget)),
                      floatingActionButton: needsFloatingBotton
                          ? Stack(children: <Widget>[
                              if (sample!.sourceLink != null && sample!.sourceLink != '')
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            Text('Source: ', style: TextStyle(fontSize: 16, color: model.textColor)),
                                            Text(sample!.sourceText!, style: const TextStyle(fontSize: 14, color: Colors.blue)),
                                          ],
                                        ),
                                      ),
                                    ),
                                ...
                                Align(
                                  ...
                                  child: FloatingActionButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      showBottomSheetSettingsPanel(context, settingsContent);
                                    },
                                    backgroundColor: model.paletteColor,
...
Widget getLeftSideDrawer(SampleModel model) {
  return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
    return SizedBox(
        width: MediaQuery.of(context).size.width * (MediaQuery.of(context).size.width < 600 ? 0.7 : 0.4),
        child: Drawer(
            child: Container(
          color: model.themeData.colorScheme.brightness == Brightness.dark ? Colors.black : Colors.white,
          child: Column(
            children: <Widget>[
              Stack(children: <Widget>[
                if (model.themeData.colorScheme.brightness == Brightness.light)
                  ...
                  Container(
                    padding: const EdgeInsets.fromLTRB(10, 30, 30, 10),
                    child: Image.asset('images/image_nav_banner_darktheme.png', fit: BoxFit.cover),
                  )
              ]),
              Expanded(
                ...
                child: ListView(
                  children: <Widget>[
                                          ...
                                          children: <Widget>[
                                            ...
                                            Row(children: <Widget>[
                                              Image.asset('images/product.png',
                                                  fit: BoxFit.contain, height: 22, width: 22, color: model.webIconColor),
                                              Padding(
                    ...
                    Padding(
                      ...
                      child: Container(height: 2, width: 5, color: model.backgroundColor),
                    ),
                    Padding(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: <Widget>[
                                          Padding(
                                              padding: const EdgeInsets.fromLTRB(15, 0, 0, 0),
                                              child: Image.asset('images/img_maui.png', fit: BoxFit.contain, height: 28, width: 28)),
                                          Container(
                                          ...
                                          const Spacer(),
                                          Icon(Icons.arrow_forward, color: model.backgroundColor),
                                        ],
                                      ),
                                      const Padding(padding: EdgeInsets.only(top: 10)),
                                    ],
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: <Widget>[
                                          Padding(
                                              padding: const EdgeInsets.fromLTRB(15, 0, 0, 0),
                                              child: Image.asset('images/img_xamarin.png', fit: BoxFit.contain, height: 28, width: 28)),
                                          Container(
                                              padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: <Widget>[
                                          Padding(
                                              padding: const EdgeInsets.fromLTRB(15, 0, 0, 0),
                                              child: Image.asset('images/img_xamarin_ui.png', fit: BoxFit.contain, height: 28, width: 28)),
                                          Container(
                                            padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Align(
                        ...
                        child: Image.asset(
                          model.themeData.colorScheme.brightness == Brightness.dark ? 'images/syncfusion_dark.png' : 'images/syncfusion.png',
                          fit: BoxFit.contain,
                          height: 50,
                          width: 100,
                        )),
...
Widget getFooter(BuildContext context, SampleModel model) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      color: model.themeData.colorScheme.brightness == Brightness.dark ? const Color.fromRGBO(33, 33, 33, 1) : const Color.fromRGBO(234, 234, 234, 1),
    ),
    padding: model.isMobileResolution
        ? EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * 0.025, 0, MediaQuery.of(context).size.width * 0.025, 0)
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                InkWell(
                  onTap: () {},
                  child: const Text('Documentation', style: TextStyle(color: Colors.blue, fontSize: 12)),
                ),
                Text(' | ', style: TextStyle(fontSize: 12, color: model.textColor.withOpacity(0.7))),
                InkWell(
                  onTap: () {},
                  child: const Text('Forum', style: TextStyle(color: Colors.blue, fontSize: 12)),
                ),
                Text(' | ', style: TextStyle(fontSize: 12, color: model.textColor.withOpacity(0.7))),
                InkWell(
                  onTap: () {},
                  child: const Text('Blog', style: TextStyle(color: Colors.blue, fontSize: 12)),
                ),
                Text(' | ', style: TextStyle(fontSize: 12, color: model.textColor.withOpacity(0.7))),
                InkWell(
                  onTap: () {},
                  child: const Text('Knowledge base', style: TextStyle(color: Colors.blue, fontSize: 12)),
                )
              ],
            ),
            Container(
                ...
                child: Text('Copyright © 2001 - 2023 Syncfusion Inc.',
                    style: TextStyle(color: model.textColor.withOpacity(0.7), fontSize: 12, letterSpacing: 0.23)))
          ],
        ),
        InkWell(
          onTap: () {},
          child: Image.asset(model.themeData.colorScheme.brightness == Brightness.dark ? 'images/syncfusion_dark.png' : 'images/syncfusion.png',
              fit: BoxFit.contain, height: 25, width: model.isMobileResolution ? 80 : 120),
        ),
      ],
    ),
  );
...
Widget showWebThemeSettings(SampleModel model) {
  ...
  return StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
    ...
    final Color textColor =
        model.themeData.colorScheme.brightness == Brightness.light ? const Color.fromRGBO(84, 84, 84, 1) : const Color.fromRGBO(218, 218, 218, 1);
    return Drawer(
        child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text('   Settings',
                        style: TextStyle(color: model.textColor, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Roboto-Medium')),
                    IconButton(
                  ...
                  child: ListView(
                    children: <Widget>[
                                ...
                                children: <int, Widget>{
                                  0: Container(
                                      ...
                                      child: Text('Light theme',
                                          style: TextStyle(color: selectedValue == 0 ? Colors.white : textColor, fontFamily: 'Roboto-Medium'))),
                                  1: Container(
                                      width: width,
                                      alignment: Alignment.center,
                                      child: Text('Dark theme',
                                          style: TextStyle(color: selectedValue == 1 ? Colors.white : textColor, fontFamily: 'Roboto-Medium')))
                                },
                      ...
                      Container(
                          ...
                          child: const Text(
                            'Theme colors',
                            style: TextStyle(color: Color.fromRGBO(128, 128, 128, 1), fontSize: 14, fontFamily: 'Roboto-Regular'),
                          )),
                      Container(
                            ...
                            children: <Widget>[
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: _addColorPalettes(model, setState)),
                                ),
                              ),
                            ],
                          )),
                      Container(
                        ...
                        child: ElevatedButton(
                            style: ButtonStyle(
                              backgroundColor: MaterialStateProperty.all<Color>(model.paletteColor),
                            ),
                            onPressed: () => _applyThemeAndPaletteColor(model, context, selectedValue),
                            child: const Text('APPLY', style: TextStyle(fontSize: 16, fontFamily: 'Roboto-Bold', color: Colors.white))),
                      )
                    ],
                  ),
                ),
...
void _applyThemeAndPaletteColor(SampleModel model, BuildContext context, int selectedValue) {
  ...
  model.currentThemeData = model.currentThemeData!.copyWith(
      colorScheme: model.currentThemeData!.colorScheme
          .copyWith(primary: model.currentPaletteColor, secondary: model.currentPaletteColor, onPrimary: Colors.white));
  ...
  if (item.subItems == null) {
    ...
    for (int i = 0; i < item.subItems!.length; i++) {
      if (item.subItems![i].subItems == null) {
        if (item.subItems![i].status == 'New' || item.subItems![i].status == 'new') {
          newCount++;
        } else if (item.subItems![i].status == 'Updated' || item.subItems![i].status == 'updated') {
          updateCount++;
        }
      } else {
        for (int j = 0; j < item.subItems![i].subItems.length; j++) {
          if (item.subItems![i].subItems[j].status == 'New' || item.subItems![i].subItems[j].status == 'new') {
            newCount++;
          } else if (item.subItems![i].subItems[j].status == 'Updated' || item.subItems![i].subItems[j].status == 'updated') {
            updateCount++;
          }
        }
      }
...
void showBottomSettingsPanel(SampleModel model, BuildContext context) {
  ...
  final double orientationPadding = ((MediaQuery.of(context).size.width) / 100) * 10;
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text('Settings',
                            style: TextStyle(
                                color: model.textColor, fontSize: 18, letterSpacing: 0.34, fontFamily: 'HeeboBold', fontWeight: FontWeight.w500)),
                        IconButton(
                          icon: Icon(
                            Icons.close,
                            color: model.textColor,
                          ...
                          child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                            return CupertinoSegmentedControl<int>(
                              children: <int, Widget>{
                                0: Container(
                                    ...
                                    child: Text('System theme',
                                        style: TextStyle(color: selectedIndex == 0 ? Colors.white : textColor, fontFamily: 'HeeboMedium'))),
                                1: Container(
                                    width: width,
                                    alignment: Alignment.center,
                                    child: Text('Light theme',
                                        style: TextStyle(color: selectedIndex == 1 ? Colors.white : textColor, fontFamily: 'HeeboMedium'))),
                                2: Container(
                                    width: width,
                                    alignment: Alignment.center,
                                    child: Text('Dark theme',
                                        style: TextStyle(color: selectedIndex == 2 ? Colors.white : textColor, fontFamily: 'HeeboMedium')))
                              },
                              unselectedColor: Colors.transparent,
                              selectedColor: model.paletteColor,
                              pressedColor: model.paletteColor,
                              ...
                              onValueChanged: (int value) {
                                selectedIndex = value;
                                if (value == 0) {
                                  model.currentThemeData = model.systemTheme.brightness != Brightness.dark
                                      ? ThemeData.from(colorScheme: const ColorScheme.light())
                                      : ThemeData.from(colorScheme: const ColorScheme.dark());
                                } else if (value == 1) {
                                  model.currentThemeData = ThemeData.from(colorScheme: const ColorScheme.light());
                                } else {
                                  model.currentThemeData = ThemeData.from(colorScheme: const ColorScheme.dark());
                                }
                                setState(() {
                      ...
                      child: MediaQuery.of(context).orientation == Orientation.portrait
                          ? Row(
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsets.fromLTRB(15, 0, 10, 30),
                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: _addColorPalettes(model)),
                                  ),
                                ),
                              ],
                            )
                          : Row(
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.fromLTRB(orientationPadding + 10, 0, orientationPadding + 10, 30),
                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: _addColorPalettes(model)),
                                  ),
                                ),
                              ],
              ...
              Align(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () => _applyThemeAndPaletteColor(model, context, selectedIndex),
                        child: const Text('APPLY', style: TextStyle(fontFamily: 'HeeboMedium', color: Colors.white))),
                  ))
            ],
          )));
}
      ...
      builder: (BuildContext context) => Container(
            ...
            child: Stack(children: <Widget>[
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text('Settings', style: TextStyle(color: model.textColor, fontSize: 18, letterSpacing: 0.34, fontWeight: FontWeight.w500)),
                  IconButton(
                    icon: Icon(
                      Icons.close,
                      color: model.textColor,
              ...
              Theme(
                  ...
                  child: Padding(padding: const EdgeInsets.fromLTRB(10, 50, 0, 0), child: propertyWidget))
            ]),
          ));
}
            ...
            child: Container(
              ...
              child: Stack(children: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text('Description', style: TextStyle(color: model.textColor, fontSize: 18, letterSpacing: 0.34, fontWeight: FontWeight.bold)),
                    IconButton(
                      icon: Icon(
                        Icons.close,
                        color: model.textColor,
                ...
                Padding(
                    ...
                    child: ListView(shrinkWrap: true, children: <Widget>[
                      RichText(
                        ...
                        text: TextSpan(
                          text: textSpan!.text,
                          style: TextStyle(color: model.textColor, fontWeight: FontWeight.normal, fontSize: 15.0, letterSpacing: 0.2, height: 1.2),
                          children: textSpans,
                        ),
                      )
                    ]))
